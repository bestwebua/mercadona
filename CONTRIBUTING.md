...
3. mercadona [issue template](.github/ISSUE_TEMPLATE/issue_report.md)/[bug template](.github/ISSUE_TEMPLATE/bug_report.md)
...
1. mercadona [pull request template](.github/PULL_REQUEST_TEMPLATE.md)
